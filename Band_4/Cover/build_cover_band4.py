# -*- coding: utf-8 -*-
"""
Baut das KDP-Full-Cover fuer Band 4 (6 x 9 Zoll, 300 dpi, weisses Papier).
...
# EINSTELLUNGEN
# --------------------------------------------------------------------------
FRONT = os.path.join(BASE, "front_band4.png")   # Vorderseite MIT Typografie
BACK = os.path.join(BASE, "back_band4.png")     # Rueckseite MIT Typografie

# !! Vor dem finalen Lauf durch die ECHTE Seitenzahl aus dem KDP-Previewer
#    ersetzen. Die Schaetzung stammt aus 16.609 Woertern / ~140 Woerter pro Seite.
PAGE_COUNT = 120
...
SPINE_NUMBER = "4"
SPINE_TITLE = "Das versunkene Dorf"
...
OUT_FULL_PNG = os.path.join(BASE, "Band4_Cover_KDP_6x9_300dpi.png")
OUT_FULL_PDF = os.path.join(BASE, "Band4_Cover_KDP_6x9_300dpi.pdf")
OUT_EBOOK = os.path.join(BASE, "Band4_Cover_eBook_1600x2560.png")
...
def draw_spine(w, h):
    ...
    # gedruckte Buch, sonst steht Band 4 im Regal falsch herum.)
...
def main():
    for p in (FRONT, BACK):
        if not os.path.exists(p):
            ...
            print("       siehe Cover_Konzept_Band4.md, Abschnitt 10.")
            return
