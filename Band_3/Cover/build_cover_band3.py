# -*- coding: utf-8 -*-
"""
Baut das KDP-Full-Cover fuer Band 3 (6 x 9 Zoll, 300 dpi, weisses Papier).
...
# EINSTELLUNGEN
# --------------------------------------------------------------------------
FRONT = os.path.join(BASE, "front_band3.png")   # Vorderseite MIT Typografie
BACK = os.path.join(BASE, "back_band3.png")     # Rueckseite MIT Typografie

# !! Schaetzung -- durch die ECHTE Seitenzahl aus dem KDP-Previewer ersetzen.
# Band 3 hat ~22.140 Woerter auf 5x8 -> grob ~150 Seiten.
PAGE_COUNT = 150
...
OUT_FULL_PNG = os.path.join(BASE, "Band3_Cover_KDP_6x9_300dpi.png")
OUT_FULL_PDF = os.path.join(BASE, "Band3_Cover_KDP_6x9_300dpi.pdf")
OUT_EBOOK = os.path.join(BASE, "Band3_Cover_eBook_1600x2560.png")
...
def draw_spine(w, h):
    ...
    #
    # NACHGEMESSEN an Band 3 und Band 3: beide Ruecken laufen von OBEN NACH
    ...
    # gedruckte Buch, sonst steht Band 3 im Regal falsch herum.)
...
def main():
    for p in (FRONT, BACK):
        if not os.path.exists(p):
            ...
            print("       siehe Cover_Konzept_Band3.md, Abschnitt 10.")
            return
