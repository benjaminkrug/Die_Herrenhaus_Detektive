"""
Erstellt ein KDP-fertiges Word-Dokument aus den Markdown-Kapiteldateien fuer Band 3.
"""
import re
import os
...
CHAPTER_FILES = [
    f"Die_Herrenhaus_Detektive_Band3_Kapitel{i}.md" for i in range(1, 20)
]

# Kapiteltitel
CHAPTER_TITLES = {
    1: "Das zweite X",
    2: "Der Mann mit der Axt",
    3: "Risse im Pflaster",
    4: "Der Brief von Winter",
    5: "Die verschwundene Linie",
    6: "Der Förster",
    7: "Hohler Boden",
    8: "Das alte Wehr",
    9: "Der Weg zurück",
    10: "Zurück im Dorf",
    11: "Der erste Versuch",
    12: "Jetzt regnet es",
    13: "Bens Idee am Wehr",
    14: "Vier Hände",
    15: "Heinrich Winter",
    16: "Das letzte Zittern",
    17: "Das Dorf atmet auf",
    18: "Der Förster und der Wald",
    19: "Der Anfang von etwas Größerem",
}
...
def add_dedication_page(doc):
    ...
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    run = p.add_run(
        "Für alle, die einen Wald sehen —\n"
        "und sich trauen hineinzugehen."
    )
    run.font.size = Pt(12)
...
def parse_markdown_chapter(filepath):
    ...
    # Entferne die Buch-Header (# Die Herrenhaus-Detektive, ## Band 3, ---)
    lines = content.split('\n')
...
def add_end_page(doc):
    ...
    lines = [
        ...
        "",
        "Jonas, Mila und Ben sind in den Wald gegangen.",
        "Sie haben die zweite Quelle gefunden — und das Dorf gerettet.",
        "Heinrich Winter ist endlich nach Hause gekommen.",
        "Und zwei alte Freunde haben wieder zueinander gefunden.",
        "",
        "Aber im Schlamm lag eine Münze …",
        "",
        "Drei Wellen und ein Stern.",
        "Ein Zeichen, das niemand kennt.",
        "Und es zeigt nach draußen — weit hinter die Hügel.",
        "",
...
def main():
    print("Erstelle KDP-Manuskript fuer Band 3...")
    doc = setup_document()
    ...
    # 8. Band 4 Vorschau
    print("  Band 4 Vorschau")
    add_band4_teaser(doc)
