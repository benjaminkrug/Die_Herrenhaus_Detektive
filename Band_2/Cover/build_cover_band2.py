...
# EINSTELLUNGEN
# --------------------------------------------------------------------------
FRONT = os.path.join(BASE, "front_band2.png")   # Vorderseite MIT Typografie
BACK = os.path.join(BASE, "back_band2.png")     # Rueckseite MIT Typografie
...
SPINE_NUMBER = "2"
SPINE_TITLE = "Das Geheimnis des Brunnens"
...
def draw_spine(w, h):
    ...
    # gedruckte Buch, sonst steht Band 2 im Regal falsch herum.)
...
def main():
    for p in (FRONT, BACK):
        if not os.path.exists(p):
            ...
            print("       siehe Cover_Konzept_Band2.md, Abschnitt 10.")
            return
